...
/*if ('error' !== $configFileCheck['result'] && 'Active' === $checkLicense['status'] && 'license_install' === $activePage) {
...
<div class=\"messagePerm ";
    if ('0755' === $configFileCheck['permission'] || '0777' === $configFileCheck['permission']) {
        echo 'hide';
    }

    echo "\"><p class=\"alert alert-warning\">This license is invalid, possible reason: Your service has been SUSPENDED, contact https://legazy.systems for more information.</p><center><a href=\"index.php\" class=\"btn btn-info\">Reload</a></center></div>
	...
	?>
        ...
        <div id="InstallationDone" style="color: green;" class="hideOnload">
            ...
            1. Please remove the license_install.php file from your server. 

            <br>   

            <br>   

            You should now delete the  license_install.php file from your web server
